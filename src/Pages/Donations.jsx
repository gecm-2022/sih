  ...
  return (
    <div className="min-h-screen bg-gray-50 p-10">
      ...
      <div className="text-center">
        <h1 className="text-4xl font-bold mb-4">Support Our Alumni Community</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Your contribution helps us fund scholarships, events, and opportunities for alumni and students. Together, we can make a difference.
        </p>
